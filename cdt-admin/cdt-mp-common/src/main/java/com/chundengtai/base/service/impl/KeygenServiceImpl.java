...
import com.chundengtai.base.keygen.DefaultKeyGenerator;
...
public class KeygenServiceImpl implements KeygenService {
    ...
    private void initWorkerId() {
        ...
        try {
            ...
            log.warn(String.format("Wrong hostname:%s, hostname must be end with number!", hostName));
            initIpWorkerId();
        }
        if (workerId != null) {
