...
let vue = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = this.baseForm.data.id == null ? "../cdtScoreFlow/saveModel.json" : "../cdtScoreFlow/updateModel.json";
        ...
        deleteModel: function (ids) {
            ...
            Ajax.request({
                type: "POST",
                url: "../cdtScoreFlow/deleteModel.json",
                contentType: "application/json",
        ...
        getModel: function (id) {
            let that = this;
            Ajax.request({
                url: "../cdtScoreFlow/getModel/" + id + ".json",
                async: true,
                successCallback: function (res) {
