...
let vue = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = this.baseForm.data.id == null ? "../cdtUserScore/saveModel.json" : "../cdtUserScore/updateModel.json";
        ...
        deleteModel: function (ids) {
            ...
            Ajax.request({
                type: "POST",
                url: "../cdtUserScore/deleteModel.json",
                contentType: "application/json",
        ...
        getModel: function (id) {
            let that = this;
            Ajax.request({
                url: "../cdtUserScore/getModel/" + id + ".json",
                async: true,
                successCallback: function (res) {
