...
let vue = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = this.baseForm.data.id == null ? "../cdtScore/saveModel.json" : "../cdtScore/updateModel.json";
