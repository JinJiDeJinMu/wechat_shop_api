const defaultModel = {
    ...
    secondPercent: null,
    firstPartner: null,
    firstPersonCondition: null,
    secondPartner: null,
    secondPersonCondition: null,
    thirdPartner: null,
    thirdTotalMoney: null,
    revision: null,
    status: null,
    createdBy: null,
    createdTime: null,
...
let vue = new Vue({
    ...
    methods: {
        saveOrUpdate: function (event) {
            var url = this.baseForm.data.id == null ? "../cdtDistrimoney/saveModel.json" : "../cdtDistrimoney/updateModel.json";
        ...
        deleteModel: function (ids) {
            ...
            Ajax.request({
                type: "POST",
                url: "../cdtDistrimoney/deleteModel.json",
                contentType: "application/json",
        ...
        getModel: function (id) {
            let that = this;
            Ajax.request({
                url: "../cdtDistrimoney/getModel/" + id + ".json",
                async: true,
                successCallback: function (res) {
