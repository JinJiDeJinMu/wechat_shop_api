...
<#if holidayList??&&(holidayList?size>0) >
    <h3><font color="green">15天后的 <#list holidayList as holidayL>${(holidayL.holiday)!}</#list>
            是中国传统节日<#list holidayList as holidayL>${(holidayL.holiday_name)!}</#list>，请您为后续的代理维护做好准备！</h3>
    <table class="xwtable">
        <thead>
        <tr>
            <td style="width:80px;">用户姓名</td>
