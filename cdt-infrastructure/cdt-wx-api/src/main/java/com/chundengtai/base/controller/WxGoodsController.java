...
@Api(tags = "v2商品管理")
@RestController
@RequestMapping("/apis/v2/goods")
public class WxGoodsController extends ApiBaseAction {
    @Autowired
    private CategoryService cdtCategoryService;
    @Autowired
...
//        Map<String, Object> resultObj = new HashMap();
//        //
//        CategoryVo currentCategory = cdtCategoryService.queryObject(id);
//        //
