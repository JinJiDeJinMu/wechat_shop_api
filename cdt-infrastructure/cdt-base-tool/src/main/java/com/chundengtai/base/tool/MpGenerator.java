...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUsername(Generator.DB_USER_NAME);
        dsc.setPassword(Generator.DB_PWD);
        dsc.setUrl(Generator.DB_CONNECTION);
...
//                // 自定义输入文件名称
//                return  System.getProperty("user.dir")+"/src/main/" + tableInfo.getEntityName() + "ListIndex.html";
//            }
//        });
