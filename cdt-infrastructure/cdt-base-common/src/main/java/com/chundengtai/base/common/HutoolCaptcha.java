...
public class HutoolCaptcha extends LineCaptcha {
    ...
    public HutoolCaptcha(int width, int height, int codeCount, int interfereCount) {
        super(width, height, codeCount, interfereCount);
    }

    @Override
    protected void generateCode() {
        this.code = RandomUtil.randomString(CAPTCHA_CODE, this.generator.generate().length());
    }
    ...
    public Image createImage(String code) {
        ...
        // 文字
        final int len = this.generator.generate().length();
